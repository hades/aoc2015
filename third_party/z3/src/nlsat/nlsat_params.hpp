...
struct nlsat_params {
  params_ref const& p;
  params_ref g;
  nlsat_params(params_ref const& _p = params_ref::get_empty()): p(_p), g(gparams::get_module("nlsat")) {}
  static void collect_param_descrs(param_descrs& d) {
    ...
    d.insert("simplify_conflicts", CPK_BOOL,
             "simplify conflicts using equalities before resolving them in nlsat solver.", "true", "nlsat");
    ...
    d.insert("inline_vars", CPK_BOOL,
             "inline variables that can be isolated from equations (not supported in incremental mode)", "false",
             "nlsat");
