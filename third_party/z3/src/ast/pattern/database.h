static char const g_pattern_database[] =
    ...
    "                   (not (or (not (= (?select2 h (?select2 h o (?AsPeerField f)) ?ownerRef_) (?select2 h o "
    "?ownerRef_)))\n"
    "                            (not (= (?select2 h (?select2 h o (?AsPeerField f)) ?ownerFrame_) (?select2 h o "
    "?ownerFrame_))))))\n"
    ...
    "                   (= (?select2 h (?select2 h o ?ownerRef_) ?localinv_) (?BaseClass_ (?select2 h o "
    "?ownerFrame_)))\n"
    "                   (not (or (not (= (?select2 h o ?inv_) (?typeof_ o)))\n"
    "                            (not (= (?select2 h o ?localinv_) (?typeof_ o))))))\n"
    "                  :pattern (?subtypes (?select2 h (?select2 h o ?ownerRef_) ?inv_) (?select2 h o "
    "?ownerFrame_)))))\n"
    ...
    "                  :pattern ((?subtypes (?typeof_ a) (?RefArray T r)) (?RefArrayGet (?select2 heap a ?elements_) "
    "i)))))\n"
