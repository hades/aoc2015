...
struct nnf_params {
  params_ref const& p;
  params_ref g;
  nnf_params(params_ref const& _p = params_ref::get_empty()): p(_p), g(gparams::get_module("nnf")) {}
  static void collect_param_descrs(param_descrs& d) {
    ...
    d.insert("mode", CPK_SYMBOL,
             "NNF translation mode: skolem (skolem normal form), quantifiers (skolem normal form + quantifiers in "
             "NNF), full",
             "skolem", "nnf");
    d.insert("ignore_labels", CPK_BOOL,
             "remove/ignore labels in the input formula, this option is ignored if proofs are enabled", "false", "nnf");
  }
  /*
