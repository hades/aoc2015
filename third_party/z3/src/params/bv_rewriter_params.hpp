...
struct bv_rewriter_params {
  params_ref const& p;
  params_ref g;
  bv_rewriter_params(params_ref const& _p = params_ref::get_empty()): p(_p), g(gparams::get_module("rewriter")) {}
  static void collect_param_descrs(param_descrs& d) {
    ...
    d.insert("hi_div0", CPK_BOOL, "use the 'hardware interpretation' for division by zero (for bit-vector terms)",
             "true", "rewriter");
