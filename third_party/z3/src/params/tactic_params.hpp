...
struct tactic_params {
  params_ref const& p;
  params_ref g;
  tactic_params(params_ref const& _p = params_ref::get_empty()): p(_p), g(gparams::get_module("tactic")) {}
  static void collect_param_descrs(param_descrs& d) {
    ...
    d.insert("solve_eqs.max_occs", CPK_UINT,
             "maximum number of occurrences for considering a variable for gaussian eliminations.", "4294967295",
             "tactic");
    d.insert("blast_term_ite.max_inflation", CPK_UINT, "multiplicative factor of initial term size.", "4294967295",
             "tactic");
    d.insert("blast_term_ite.max_steps", CPK_UINT, "maximal number of steps allowed for tactic.", "4294967295",
             "tactic");
