...
struct model_params {
  params_ref const& p;
  params_ref g;
  model_params(params_ref const& _p = params_ref::get_empty()): p(_p), g(gparams::get_module("model")) {}
  static void collect_param_descrs(param_descrs& d) {
    ...
    d.insert("compact", CPK_BOOL,
             "try to compact function graph (i.e., function interpretations that are lookup tables)", "true", "model");
